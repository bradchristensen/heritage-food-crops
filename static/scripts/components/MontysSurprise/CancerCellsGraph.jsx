            ...
            <Container>
                <div style={{ width: '100%' }}>
                    ...
                    <div style={{ backgroundColor: '#eee', textAlign: 'left', padding: '20px 25px' }}>
                        ...
                        <small>Note: this interactive graph has been generated based on <a href="/static/images/layout/montys-surprise/graph-cancer-cell-proliferation.png">the original bitmap image</a>. <nobr>Data points are estimates.</nobr></small>
                    </div>
                </div>
            </Container>
        );
