...
<Article className='page-heirloom-tomatoes'>
    ...
    <div className='wrapper'>
        ...
        <div className='box'>
            <SectionHeading>Appendix: Tomato varieties confirmed to contain Tetra-cis-lycopene</SectionHeading>

            <p>Tetra-cis-lycopene is a highly beneficial bioavailable form of lycopene, and exhibits a golden-orange or tangerine tomato colour. But not all tomatoes with this colour contain tetra-cis-lycopene, as this colour can also be expressed by beta-carotene. Hence it is necessary to chemically analyse each tomato variety to verify whether or not it contains tetra-cis-lycopene.</p>
                ...
                <table style={{ width: '100%', margin: 0 }}>
                    <thead>
                        ...
                        <tr>
                            {[
                                ...
                                ['pH', 'pH'],
                                ['ranking', 'Ranking']
                            ].map(column => ({ id: column[0], name: column[1] })).map((column, index) => {
                                return <th key={'tomato-table-header-' + column.id}
                    ...
                    <tbody>
                        {this.state.tomatoTable.map((row, index) => {
                            return <tr key={'tomato-table-row-' + index}
            ...
            <p>* The level of tetra-cis-lycopene is very dependent upon the ripening state of the tomato, with maximum levels appearing to be at the optimum full ripeness stage for picking and immediate eating. Our 'Moonglow' tomatoes were picked early and therefore their level of 5.38 for tetra-cis-lycopene will be greater if left to ripen further.</p>
            {/* <p>**Data for the 'Tangerine' variety was not available for this 2015 season, however based on its previous analysis we have estimated its level for the purpose of this table.</p> */ }
