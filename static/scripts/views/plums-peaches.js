    ...
    render () {
        return <Article className='page-plums-peaches'>
            <div className='wrapper'>
                <div className='box'>
                    <SectionHeading>Plums</SectionHeading>
                ...
                <div className='box'>
                    <SectionHeading>European Plums (Prunes, Damsons and Greengages)</SectionHeading>
                    <p>These plum varieties typically contain very high levels of:</p>
                    <ul>
                        <li>Anthocyanins
                            <ul>
                ...
                <div className='box'>
                    <SectionHeading>Peaches</SectionHeading>
                ...
                <div className='box'>
                    ...
                    <div style={{ height: '240px', padding: '0 20px 20px 20px' }}>
