    ...
    render () {
        return <Article className='page-huntingtons-disease'>
            ...
            <div className='wrapper'>
                ...
                <div className='box'>
                    <p>This research sought to determine whether natural trehalose sugar found in a particular desert plant could prove effective for treating the symptoms of Huntington's disease.</p>
                </div>
                ...
                <div className='splitter right'>
                    <div className='box'>
                        <img src='/static/img/layout/huntingtons-disease/03.jpg' alt={'Selaginella Lepidophylla (the Resurrection Plant) growing in the Trust\'s plant containment facility'} className='fill' />
                        <p>Selaginella Lepidophylla<em> (the Resurrection Plant) growing in the Trust's plant containment facility.</em></p>
                    </div>
                </div>
                ...
                <div className='box'>
                    ...
                    <p><em>Plants of </em>Selaginella Lepidophylla<em> (the Resurrection Plant) growing in the Trust's plant containment facility.</em></p>
                </div>

                <div className='box'>
                    <SectionSubheading>HPLC Chromatogram of <em>Selaginella lepidophylla</em> Dried Powder</SectionSubheading>
                ...
                <div className='box'>
                    ...
                    <p>The Trust (which was created to continue research begun by the Central Districts Branch of the New Zealand Tree Crops Association) has, over recent years, played a leading role in locating, identifying and propagating heritage apple varieties. The Trust has also conducted six years of research to evaluate the levels of beneficial compounds in these heritage apple varieties and to compare the results with those of commercial apples.</p>

                    <p>This research has led to the discovery and identification of high health apple varieties, in particular the Monty's Surprise variety, which contains superior levels of procyanidin and quercetin flavonoid compounds in the skin. This variety has extremely high antioxidant levels, and cell culture testing has found that samples of Monty's Surprise apples and cider containing these high procyanidin levels have very potent antiproliferative effectiveness against both colon and stomach cancer cells.</p>

                    <p>This research has been able to identify certain types of varieties, in particular seedling varieties, with more likelihood of containing substantially higher levels of compounds than other varieties. In this study, over 250 apple varieties were collected and chemically analysed, in this attempt to find the best apples high in medicinal potential and anti-cancer effectiveness.</p>

                    <p>The weight of evidence indicating the superior medicinal qualities of the Monty's Surprise apple variety has seen the Trust members initiate the free distribution of thousands of these trees to residents of Whanganui and the surrounding region.</p>
                ...
                <div className='box'>
                    ...
                    <p><strong>The following paragraphs are referenced from the April/May 2006 magazine, "Scientific American Mind", article by Andrich Juergen & Joerg T. Epplen.</strong></p>
