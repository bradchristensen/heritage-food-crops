    ...
    render () {
        return <Article className='wrapper page-montys-surprise'>
            ...
            <div className='box'>
                ...
                <p>We were absolutely delighted to hear of these results, as they provided evidence for us to focus our research attention upon this unique New Zealand seedling apple variety.
            ...
            <div className='splitter'>
                <div className='box'>
                    <img src='/files/07brad.jpg' alt={'Brad Christensen helping pick Monty\'s Surprise apples from the mother tree for research'} className='fill' />
                    <p><em>Brad Christensen helping pick Monty's Surprise apples from the mother tree for research.</em></p>
                </div>
            </div>

            <div className='splitter right'>
                <div className='box'>
                    <img src='/files/08cider_800.jpg' alt={'Monty\'s Surprise apples, cider and apple jelly'} className='fill' />
                    <p><em>Monty's Surprise apples, cider and apple jelly.</em></p>
                </div>

                <div className='box'>
                    <img src='/files/02donandtree_800.jpg' alt={'The original Monty\'s Surprise tree'} className='fill' />
            ...
            <div className='splitter'>
                <div className='box'>
                    <img src='/static/images/layout/montys-surprise/roles/dried-apple-rings.jpg' alt='Preparing apple for dehydrating for eating as dried apple rings later in the year' className='fill' />
                    <p><em>Preparing apple for dehydrating for eating as dried apple rings later in the year.</em></p>
                </div>

                <div className='box'>
                    <img src='/static/images/layout/montys-surprise/roles/biscotti.jpg' alt={'Monty\'s Surprise biscotti made by Melinda Hatherly-Jones'} className='fill' />
                    <p><em>Monty's Surprise biscotti made by Melinda Hatherly-Jones.</em></p>
                </div>

                <div className='box'>
                    <img src='/static/images/layout/montys-surprise/roles/steph-apple-cake.jpg' alt={'Steph Lambert with her Monty\'s Surprise Winter apple cake, made from Monty\'s Surprise dried apple pulp'} className='fill' />
                    <p><em>Steph Lambert with her Monty's Surprise Winter apple cake, made from Monty's Surprise dried apple pulp.</em></p>
                </div>
            </div>

            <div className='splitter right'>
                <div className='box'>
                    <img src='/static/images/layout/montys-surprise/roles/joy-and-sharon.jpg' alt={'Joy Bristol and Sharon Duff with one of the Monty\'s Surprise apples about to be pressed for juice, cider or cider vinegar'} className='fill' />
                    <p><em>Joy Bristol and Sharon Duff with one of the Monty's Surprise apples about to be pressed for juice, cider or cider vinegar.</em></p>
                </div>

                <div className='box'>
                    <img src='/static/images/layout/montys-surprise/roles/flower-essence.jpg' alt={'Monty\'s Surprise flowers floating in spring water as part of the process for making a Monty\'s Surprise Bach flower essence'} className='fill' />
                    <p><em>Monty's Surprise flowers floating in spring water as part of the process for making a Monty's Surprise Bach flower essence.</em></p>
                </div>

                <div className='box'>
                    <img src='/static/images/layout/montys-surprise/roles/flowers-2.jpg' alt={'Monty\'s Surprise flowers'} className='fill' />
                    <p><em>Monty's Surprise flowers.</em></p>
                </div>

                <div className='box'>
                    <img src='/static/images/layout/montys-surprise/roles/infused-cider-vinegar.jpg' alt={'Monty\'s Surprise flowers infused in Monty\'s Surprise apple cider vinegar'} className='fill' />
                    <p><em>Monty's Surprise flowers infused in Monty's Surprise apple cider vinegar.</em></p>
                </div>
            </div>
            ...
            <div className='box'>
                ...
                <p>Similarly, several traditional European cider apples have been identified as having very high levels of cancer inhibiting compounds.</p>
            ...
            <div className='box'>
                ...
                <p>We also partner with local community funding organisations - the Powerco Wanganui Trust, and Whanganui Community Foundation. Both of these organisations have assisted us greatly with our community-based initiatives.</p>

                <p>Our aim with the identification, propagation and distribution of these medicinal apple trees, is to ensure the survival of a valuable but endangered bio-resource as well as provide a high level of availability within the region of a dietary element that should, in time, see an improvement in community health.</p>
            </div>

            <div className='box'>
                <h3>Recent International Research</h3>

                <p>Evidence suggests that a diet high in fruits and vegetables may decrease the risk of some serious illnesses such as cardiovascular disease and cancer, and that phytochemicals including phenolics, flavonoids and carotenoids from fruit and vegetables may play a key role in reducing chronic disease risk.</p>
                ...
                <p>One of the studies referred to was conducted by the National Public Health Institute in Helsinki, Finland<Reference source='Knekt, P.; Jarvinen, R.; Reunanen, A.; Maatela, J. Flavonoid intake and coronary mortality in Finland: a cohort study. Br. Med. J. 1996, 312, 478-81.' />. It involved 10,054 Finnish men and women. This cohort epidemiological study on the association between dietary intake of flavonoids and the risk of several chronic diseases reported that of all the main flavonoid sources, apple intake is associated with [a reduced risk of] almost all of the chronic diseases considered.</p>

                <p>Overwhelmingly, the Finnish researchers pointed to the flavonoid quercetin, a plant-based phytonutrient found most abundantly in apples, onions, tea and red wine, as the flavonoid with the best potential health-promoting capabilities.</p>

                <p>Furthermore, according to analysis of an extensive body of data over many years, those study participants who ate the most apples and the flavonoid quercetin, had the lowest risk of total mortality; that is, they had the lowest risk of dying of any cause during the decades-long study.</p>

                <p>For a number of years research has been done at Cornell University using Red Delicious apples grown in New York State to provide the extracts to study the effects of phytochemicals. The researchers compared the anti-cancer and anti-oxidant activity in the apple flesh, and also studied the fruit's skin.</p>

                <p>Using colon cancer cells treated with apple extract, the scientists found that cell proliferation was inhibited. Colon cancer cells treated with 50 milligrams of apple extract (from the skins) were inhibited by 43 percent. The apple flesh extract inhibited the colon cancer cells by 29 percent. The researchers also tested the apple extract against human liver cancer cells. At 50 milligrams the extract derived from the apple with the skin on inhibited those cancer cells by 57 percent. The apple extract derived from the fruit's fleshy part inhibited cancer cells by 40 percent.</p>

                <p>A more recent 2005 Cornell Study<Reference source='Liu, R.H.; Liu, J.; Chen, B. Apples prevent mammary tumors in rats. Journal of Agricultural and Food Chemistry. 2005.' />, found that breast cancer incidence was reduced by 17, 39 and 44 percent in rats fed the human equivalent of one, three or six apples a day, respectively over 24 weeks.</p>
                ...
                <ul>
                    <li>The results showed that every apple variety is different. Every variety has different levels of compounds and the levels between varieties can differ substantially.</li>
                    <li>It became apparent that modern apple breeding programmes that have resulted in today's commercial varieties have never used nutrition as a major criteria in their breeding programmes.</li>
                    <li>Modern commercial apple varieties appeared to have less, and in some cases considerably less, beneficial compounds in them than some heritage apple varieties.</li>
                    <li>Some heritage apple varieties contain substantial levels of compounds that give them the potential to be far superior varieties for human health.</li>
                </ul>

                <p>Two heritage varieties in particular were identified in this study as having the most potential as high health 'medicinal' apples. These were Monty's Surprise and Hetlina.</p>

                <p>In 2004 we took the opportunity to send these top two apple varieties to Cornell University for testing against cancer cells. The results indicated their potent anti-proliferative activity against both HepG2 liver cancer cells and Caco-2 colon cancer cells.</p>

                <p>In 2005 we had another 126 apple varieties chemically analysed, for the first time including a selection of traditional European cider apples. These unpalatable cider apples tested with substantial levels of compounds in the flesh, making them ideal for juice, cider and cider-vinegar production. One variety, Fuero Rous stood out for it's medicinal potential.</p>
                ...
                <p>In 2006 powdered extract samples of Monty's Surprise, Hetlina and Fuero Rous (apple; cider; cider vinegar and pips) were sent to Dr Francis Raul of the French National Institute for Health and Medical Research in Strasbourg for cancer studies. The Institute's researchers had discovered that another set of compounds, the procyanidins (or proanthocyanidins) - were also effective in killing cancer cells (in a rat model). When they found out about the very high levels of procyanadins in Monty's Surprise and Fuero Rous, they asked us if they could obtain powdered extracts of these apples for their studies.</p>

                <p>The French researchers identified the sample of Monty's Surprise cider as having the most potent antiproliferative effectiveness against human colon cancer cells, with their in vitro testing.</p>
            ...
            <div className='box'>
                ...
                <p>This is a wellbeing concept. We want to keep people healthy so that along with an increased enjoyment of life, less pressure will be placed on our existing health services.</p>
