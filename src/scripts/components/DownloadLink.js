...
export default function DownloadLink(props) {
  ...
  if (ext === "pdf") {
    ...
    className = "fexcel";
    title =
      "Spreadsheet &mdash; Microsoft Excel or OpenOffice is required to view this file.";
  } else if (ext === "doc" || ext === "docx") {
    className = "fword";
    title =
      "Word Document &mdash; Microsoft Word or OpenOffice is required to view this file.";
  } else if (
    ext === "ppt" ||
    ext === "pptx" ||
    ext === "pps" ||
    ...
    className = "fppt";
    title =
      "Presentation &mdash; Microsoft PowerPoint is required to view this slideshow.";
  }

  const target = className === "web" ? "_blank" : null;
