        ...
        <div className="wrapper wrap-900">
          <div className="feature-text">
            <p>
              ...
              charitable trust, established to research the{" "}
      ...
      <ul className="menu-larger">
          ...
          <Link to="/montys-surprise" className="menu-banner">
            ...
            >
              {src => (
                <img
                  src={src}
                  alt="The Monty's Surprise apple"
                  className="menu-banner-background-image"
                />
              )}
            </ProgressiveImage>
            <div className="menu-banner-content">
              <div className="menu-banner-content-flex-end">
                <h2 className="hide-mobile">
                  {smartQuote("The Monty's Surprise apple")}
                </h2>
                <h2 className="show-mobile-block">
                  {smartQuote("Monty's Surprise")}
                </h2>
        ...
        <li>
          <Link to="/heirloom-beans" className="menu-banner">
            <ProgressiveImage src={BannerBeans} placeholder={PlaceholderBeans}>
              {src => (
                <img
                  src={src}
                  alt="Heirloom Beans"
        ...
        <li>
          <Link to="/ancient-wheat" className="menu-banner">
            <ProgressiveImage src={BannerWheat} placeholder={PlaceholderWheat}>
              {src => (
                <img
                  src={src}
                  alt="Ancient Wheat"
