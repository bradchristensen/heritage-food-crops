...
const readMoreSecretToOurHealth = (
    <div>
        ...
        <p>
            ...
            had been found cultivated as varieties in Mexico. Those original tomatoes
            were named ‘Pomodoro’, which in Italian means ‘golden fruit’. The HFCRT
        ...
        <p>
            The HFCRT has uncovered many golden/orange tomato varieties
            ...
            We are indebted to Dr Tony McGhie and his colleagues at Plant &
            ...
            their stunning colour (ranging from golden to bright orange), sweetness,
            lower acidity and suitability for the home gardener.
        </p>
    </div>
);
...
class HeirloomTomatoes extends PureComponent {
    constructor(props) {
        ...
        this.onClickReadMoreSecretToOurHealth = this.onClickReadMoreSecretToOurHealth.bind(this);
            ...
            <div className="article-content">
                ...
                <div className="box">
                    ...
                    <p>
                        ...
                        deficient in comparison with traditional open-pollinated
                        heirloom varieties.
                    </p>
                    ...
                    <p>
                        ...
                        <Link to="/contact-us">
                            donations to help us continue our work
                        </Link>.
                    </p>

                    <p>
                        <strong>
                            To obtain seeds, please send a stamped,
                            self-addressed envelope to:
                        </strong>
                    </p>
                    <p>
                        Heritage Food Crops Research Trust<br />
                ...
                <div className="box">
                    ...
                    {this.state.readMoreSecretToOurHealth ? readMoreSecretToOurHealth : (
                        <p>
                            <a
                                className="button"
                                href="#readMore"
                ...
                <div className="box">
                    ...
                    <p>
                        ...
                        heirloom tomatoes within the golden to orange and tangerine
                        colour spectrum.
                    </p>
                    ...
                    <p>
                        ...
                        varieties chemically analysed to determine
                        whether they contain tetra-cis-lycopene or whether the colour is
                        exhibited from the beta-carotene in the tomato.
                    </p>
                    ...
                    <p>
                        ...
                        human intestinal walls and into the blood, according to Steven Schwartz
                        from Ohio State's Comprehensive Cancer Centre.
                    </p>

                    <p>
                        However tetra-cis-lycopene is much better absorbed by the body &mdash;
                        in fact two and a half times better! The structure of this
                    ...
                    <p>
                        ...
                        (<em>Solanum lycopersicum</em>) was
                        originally a golden-orange colour is a key piece of the puzzle.
                    ...
                    <p>
                        ...
                        focus of our research. We believe we have found the
                    ...
                    <p>
                        ...
                        of knowledge and technical skill, but we appear to lack the
                ...
                <div className="box">
                    ...
                    <p>
                        The Heritage Food Crops Research Trust began researching
                        heirloom tomatoes in 2007. This has culminated with the finding
                        of varieties that contain a better form of lycopene (known as
                        ...
                        found in certain golden orange heirloom tomatoes and the Trust has
                    ...
                    <p>
                        ...
                        please share a few seeds back with us, so that we can monitor and
                        analyse the ongoing development of these fruits.
                    </p>
        ...
        return (
            <Article className="page-heirloom-tomatoes">
                <div className="page-feature">
                    <Parallax src={require('../../../images/layout/tomatoes/banner.jpg')} alt="" />
